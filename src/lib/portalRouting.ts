...
export function portalPathForRole(role: string | null | undefined): string {
  ...
  if (r === "SYS" || r === "APP_OWNER" || r === "SUPER_ADMIN") {
    return "/portal/admin";
  }

  if (r === "OPERATIONS_ADMIN" || r === "ADM" || r === "MGR") {
    return "/portal/operations";
  }

  if (r === "FINANCE_USER" || r === "FINANCE_STAFF") {
    return "/portal/finance";
  }

  if (r === "MARKETING_ADMIN") {
  ...
  if (r === "SUBSTATION_MANAGER") {
    return "/portal/branch";
  }

  if (r === "STAFF" || r === "DATA_ENTRY") {
    return "/portal/operations";
  }

  if (r === "RIDER" || r === "DRIVER" || r === "HELPER") {
