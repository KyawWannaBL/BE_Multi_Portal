...
import type { WorkflowEvent } from "../types/domain";
    ...
    <div className="rounded-3xl border border-white/10 bg-[#0B1220] p-5 shadow-xl">
      ...
      <div className="space-y-4">
        {events.length ? (
            ...
            <div key={event.id} className="flex gap-4">
              ...
              <div className="flex-1 rounded-2xl border border-white/5 bg-black/20 p-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="text-xs text-white/50">{new Date(event.createdAt).toLocaleString()}</div>
                </div>
          ...
          <div className="rounded-2xl border border-white/5 bg-black/20 p-4 text-sm text-white/60">
